...
## LEDs
# set_property -dict {PACKAGE_PIN U16    IOSTANDARD LVCMOS33} [get_ports {GPIOC_INOUTPORT[0]}]
# set_property -dict {PACKAGE_PIN E19    IOSTANDARD LVCMOS33} [get_ports {GPIOC_INOUTPORT[1]}]
# set_property -dict {PACKAGE_PIN U19    IOSTANDARD LVCMOS33} [get_ports {GPIOC_INOUTPORT[2]}]
# set_property -dict {PACKAGE_PIN V19    IOSTANDARD LVCMOS33} [get_ports {GPIOC_INOUTPORT[3]}]
# set_property -dict {PACKAGE_PIN W18    IOSTANDARD LVCMOS33} [get_ports {GPIOC_INOUTPORT[4]}]
...
# set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports {GPIOD_INOUTPORT[3]}]
# set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports {GPIOD_INOUTPORT[4]}]
# set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports {GPIOD_INOUTPORT[5]}]
# set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports {GPIOD_INOUTPORT[6]}]
# set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {GPIOD_INOUTPORT[7]}]
...
# set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports btn_sec_up]
# set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports btn_clear_hour_up]
# set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports btn_run]
# set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports btn_min_up]
...
##USB-RS232 Interface
# set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports pc_rx_in]
# set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports pc_tx_out]
